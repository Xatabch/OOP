...
void rotate(double x_angle, double y_angle, double z_angle, Point *&obj, int amount_of_dots)
{
    ...
    delete_matrix_rows(tmpN, tmpDot);
    delete_matrix_rows(tmpN, tmpResult);
    delete_matrix_rows(N, y_x_result);
    delete_matrix_rows(N, z_y_x_result);
    delete_matrix_rows(N, x_rotate_matrix);
    delete_matrix_rows(N, y_rotate_matrix);
    delete_matrix_rows(N, z_rotate_matrix);
}
